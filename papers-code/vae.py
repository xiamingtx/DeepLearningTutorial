...
for epoch in range(num_epochs):
    for data in dataloader:
        ...
        optimizer.zero_grad()
        p_x, q_z = vae(inputs)
        # log_prob: Use log-likelihood to measure how well the data generated by the model matches the real data
        log_likelihood = p_x.log_prob(inputs).sum(-1).mean()
        # let q_z conform to the standard normal distribution as much as possible (prior assumption)
